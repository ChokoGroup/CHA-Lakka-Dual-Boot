...
if [ -f "/.choko/Run RetroArch 720p.nfo" ]
then
  rm "/.choko/Run RetroArch 720p."*
  echo "Menu option \"Run RetroArch (720p)\" uninstalled (Lakka files were not deleted)."
else
  echo "\"/.choko/Run RetroArch 720p.*\" not found."
fi
sleep 3
