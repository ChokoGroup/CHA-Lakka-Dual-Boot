...
if [ -f "/.choko/Run RetroArch 1080p.nfo" ]
then
  rm "/.choko/Run RetroArch 1080p."*
  echo "Menu option \"Run RetroArch (1080p)\" uninstalled (Lakka files were not deleted)."
else
  echo "\"/.choko/Run RetroArch 1080p.*\" not found."
fi
sleep 3
