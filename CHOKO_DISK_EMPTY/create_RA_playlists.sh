...
BOXARTS="/mnt/e/MAME/flyers"
SNAPS="/mnt/e/MAME/snap"
TITLES="/mnt/e/MAME/titles"
...
while read -r ZIPFILE; do
  ...
  then
    ...
    PLAYLISTNAME=${ZIPFILE%/*}; PLAYLISTNAME=${PLAYLISTNAME#"$RUNNINGFROM/roms/"}; PLAYLISTNAME=${PLAYLISTNAME//\//" - "}; PLAYLISTNAME=${PLAYLISTNAME//\./"_"}
